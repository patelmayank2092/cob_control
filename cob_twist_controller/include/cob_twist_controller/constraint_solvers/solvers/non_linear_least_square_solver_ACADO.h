...
#ifndef COB_TWIST_CONTROLLER_CONSTRAINT_SOLVERS_SOLVERS_NONLINEAR_LEAST_SQUARE_NORM_SOLVER_ACADO_H
#define COB_TWIST_CONTROLLER_CONSTRAINT_SOLVERS_SOLVERS_NONLINEAR_LEAST_SQUARE_NORM_SOLVER_ACADO_H
...
class NonLinearLeastSquareNormSolverACADO : public ConstraintSolver<>
{
    public:
    NonLinearLeastSquareNormSolverACADO(const TwistControllerParams& params,
                                const LimiterParams& limiter_params,
                                TaskStackController_t& task_stack_controller) :
                ConstraintSolver(params, limiter_params, task_stack_controller)
        {}

        virtual ~NonLinearLeastSquareNormSolverACADO()
        {}
...
#endif  // COB_TWIST_CONTROLLER_CONSTRAINT_SOLVERS_SOLVERS_NONLINEAR_LEAST_SQUARE_NORM_SOLVER_ACADO_H
