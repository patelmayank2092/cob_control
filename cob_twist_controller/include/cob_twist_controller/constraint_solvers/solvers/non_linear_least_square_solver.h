...
#ifndef COB_TWIST_CONTROLLER_CONSTRAINT_SOLVERS_SOLVERS_NONLINEAR_LEAST_SQUARE_NORM_SOLVER_H
#define COB_TWIST_CONTROLLER_CONSTRAINT_SOLVERS_SOLVERS_NONLINEAR_LEAST_SQUARE_NORM_SOLVER_H
...
{
    public:
    NonLinearLeastSquareNormSolver(const TwistControllerParams& params,
                                const LimiterParams& limiter_params,
                                TaskStackController_t& task_stack_controller) :
                ConstraintSolver(params, limiter_params, task_stack_controller)
        {}

        virtual ~NonLinearLeastSquareNormSolver()
        {}
